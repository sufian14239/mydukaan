						...
						<div class="panel-body">
							<fieldset id="account">
								<div class="form-group required">
									...
									<input type="text" class="form-control" id="input-payment-lastname" placeholder="Full Name" value="" name="fullname">
								</div>
								<div class="form-group required">
								...
								<div class="form-group required">
									...
									<input type="text" class="form-control" id="input-payment-telephone" placeholder="Phone" name="phone">
								</div>
							...
							<div class="panel panel-default no-padding">
								...
								<div class="col-sm-6  checkout-payment-methods">
									...
									<div class="panel-body">
										...
										<div class="radio">
										<label>
											<input type="radio" value="Cash on Delivery" checked="checked" name="payment_type">Cash On Delivery</label>
										</div>
										
										<div class="radio">
										<label>
											<input type="radio" value="Credit Card" name="payment_type">Credit Card</label>
										</div>
									</div>
								</div>
							</div>
			...
			$('#city').change(function(){
				...
				$.ajax({
					...
					success: function(data){
						var ship = $('#shipping_method').text(data);
