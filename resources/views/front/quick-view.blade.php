					...
					<div class="left-content-product">
						...
						<div class="content-product-left class-honizol col-md-5 col-sm-12 col-xs-12">
							<div class="large-image  ">
								<img itemprop="image" class="product-image-zoom" src="{{ asset('public/front/image/catalog/demo/product/funiture/1.jpg') }}" data-zoom-image="{{ asset('public/front/image/catalog/demo/product/funiture/1.jpg') }}" title="Chicken swinesha" alt="Chicken swinesha">
							</div>
							<a class="thumb-video pull-left" href="https://www.youtube.com/watch?v=HhabgvIIXik"><i class="fa fa-youtube-play"></i></a>
							
							<div id="thumb-slider" class="yt-content-slider full_slider owl-drag"  data-rtl="yes" data-autoplay="no" data-autoheight="no" data-delay="4" data-speed="0.6" data-margin="10" data-items_column0="4" data-items_column1="3" data-items_column2="4"  data-items_column3="1" data-items_column4="1" data-arrows="yes" data-pagination="no" data-lazyload="yes" data-loop="no" data-hoverpause="yes">
								<a data-index="0" class="img thumbnail " data-image="{{ asset('public/front/image/catalog/demo/product/funiture/1.jpg') }}" title="Chicken swinesha">
									<img src="{{ asset('public/front/image/catalog/demo/product/funiture/1.jpg') }}" title="Chicken swinesha" alt="Chicken swinesha">
								</a>
								<a data-index="1" class="img thumbnail " data-image="{{ asset('public/front/image/catalog/demo/product/funiture/2.jpg') }}" title="Chicken swinesha">
									<img src="{{ asset('public/front/image/catalog/demo/product/funiture/2.jpg') }}" title="Chicken swinesha" alt="Chicken swinesha">
								</a>
								<a data-index="2" class="img thumbnail " data-image="{{ asset('public/front/image/catalog/demo/product/funiture/3.jpg') }}" title="Chicken swinesha">
									<img src="{{ asset('public/front/image/catalog/demo/product/funiture/3.jpg') }}" title="Chicken swinesha" alt="Chicken swinesha">
								</a>
								<a data-index="3" class="img thumbnail " data-image="{{ asset('public/front/image/catalog/demo/product/funiture/4.jpg') }}" title="Chicken swinesha">
									<img src="{{ asset('public/front/image/catalog/demo/product/funiture/4.jpg') }}" title="Chicken swinesha" alt="Chicken swinesha">
								</a>
								<a data-index="4" class="img thumbnail " data-image="{{ asset('public/front/image/catalog/demo/product/funiture/5.jpg') }}" title="Chicken swinesha">
									<img src="{{ asset('public/front/image/catalog/demo/product/funiture/5.jpg') }}" title="Chicken swinesha" alt="Chicken swinesha">
								</a>
							</div>
									...
									<ul class="product-options clearfix"id="input-option231">
										<li class="radio">
											<label>
												...
												<img src="{{ asset('public/front/image/demo/colors/blue.jpg') }}" data-original-title="blue +$12.00" class="img-thumbnail icon icon-color">				<i class="fa fa-check"></i>
												<label> </label>
											</label>
										</li>
										<li class="radio">
											<label>
												...
												<img src="{{ asset('public/front/image/demo/colors/brown.jpg') }}" data-original-title="brown -$12.00" class="img-thumbnail icon icon-color">				<i class="fa fa-check"></i>
												<label> </label>
											</label>
										</li>
										<li class="radio">
											<label>
												<input class="image_radio" type="radio" name="option[231]" value="35"> <img src="{{ asset('public/front/image/demo/colors/green.jpg') }}" data-original-title="green +$12.00" class="img-thumbnail icon icon-color">				<i class="fa fa-check"></i>
												<label> </label>
											</label>
										</li>
