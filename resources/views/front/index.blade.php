    ...
    <div id="content">
        <div class="container">
                ...
                <div class="module sohomepage-slider ">
                    <div class="yt-content-slider"  data-rtl="yes" data-autoplay="no" data-autoheight="no" data-delay="4" data-speed="0.6" data-margin="0" data-items_column0="1" data-items_column1="1" data-items_column2="1"  data-items_column3="1" data-items_column4="1" data-arrows="yes" data-pagination="no" data-lazyload="yes" data-loop="no" data-hoverpause="yes">
                        <div class="yt-content-slide">
                            <a href="#"><img src="{{asset('public/front/image/catalog/slideshow/home4/slide-1.jpg')}}" alt="slider1" class="img-responsive"></a>
                        </div>
                        <div class="yt-content-slide">
                            <a href="#"><img src="{{asset('public/front/image/catalog/slideshow/home4/slide-2.jpg')}}" alt="slider2" class="img-responsive"></a>
                        </div>
                        <div class="yt-content-slide">
                            <a href="#"><img src="{{asset('public/front/image/catalog/slideshow/home4/slide-3.jpg')}}" alt="slider3" class="img-responsive"></a>
                        </div>
                    </div>
            ...
            <div class="row box-content2">
                                                ...
                                                <div class="product-image-container">
                                                    <div class="image"> 
                                                        ...
                                                        <a href="#" target="_self" title="product">
                                                            <img src="{{asset('public/front/image/catalog/demo/product/index2/330/1.jpg')}}" alt="Ground round enim" class="img-responsive">
                                                        </a>
                                            ...
                                            <div class="right-block">
                                                <div class="caption">
                                                    ...
                                                    <div class="button-group">
                                                        <button class="addToCart" title="Add" type="button" onclick="cart.add('69');"><i class="fa fa-shopping-cart"></i>  <span>Add</span>
                                                        </button>                                                        
                                            ...
                                            <div class="left-block">
                                                <div class="product-image-container">
                                                    <div class="image"> 
                                                        ...
                                                        <a href="#" target="_self" title="product">
                                                            <img src="{{asset('public/front/image/catalog/demo/product/index2/330/2.jpg')}}" alt="Hofficia chicken" class="img-responsive">
                                                        </a>
                                            ...
                                            <div class="left-block">
                                                <div class="product-image-container">
                                                    <div class="image"> 
                                                        ...
                                                        <a href="#" target="_self" title="product">
                                                            <img src="{{asset('public/front/image/catalog/demo/product/index2/330/3.jpg')}}" alt="Lastrami deserunt" class="img-responsive">
                                                        </a>
                                                    ...
                                                    <div class="left-block">
                                                        <div class="product-image-container">
                                                            <div class="image"> 
                                                                ...
                                                                @endphp
                                                                <a href="{{ route('product', ['name'=>$name, 'id'=>$product->id]) }}" target="_self" title="product">
                                                                    <img src="{{asset('public/thumbnail').'/'.$product->p_thumbnail}}" alt="Ground round enim" class="img-responsive">
                                                                </a>
               ...
               <div class="right-block">
                <div class="caption">
               <h4><a href="{{ route('product', ['name'=>$name, 'id'=>$product->id]) }}" target="_self" title="Ground round enim">{{ $product->name }}</a></h4>
                      <div class="rating">    
                                 <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                                                                <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                                                                <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                    ...
                    <div class="cat-wrap theme3 font-title yt-content-slider"  data-rtl="yes" data-autoplay="no" data-autoheight="no" data-delay="4" data-speed="0.6" data-margin="30" data-items_column0="5" data-items_column1="4" data-items_column2="3"  data-items_column3="2" data-items_column4="1" data-arrows="yes" data-pagination="no" data-lazyload="yes" data-loop="no" data-hoverpause="yes">
                       ...
                       @foreach($subcategories as $subcategory)
                        <div class="content-box">
                            <div class="image-cat">
                                @php
                                                                    $subname = str_replace(' ', '-', $subcategory->name);
                                                                @endphp
                                <a href="{{ route('category-product',$subcategory->id) }}" title="Smartphone" target="_self">
                                    <img src="{{asset('public/subcategories'.'/'.$subcategory->image)}}" title="Smartphone" alt="Smartphone" />
                                </a>
                            </div>
                            <div class="cat-title"> 
                            <a href="{{ route('category-product',$subcategory->id)}}" title="Smartphone " target="_self"> {{$subcategory->name}}</a>
                            </div>
                        </div>
                        @endforeach
                        @endif
                                        ...
                                        <div class="left-block">
                                            <div class="product-image-container">
                                                <div class="image"> 
                                                    ...
                                                    <a href="" target="_self" title="product">
                                                        <img src="{{asset('public/front/image/catalog/demo/product/index2/270/6.jpg')}}" alt="Ground round enim" class="img-responsive">
                                                    </a>
                                        ...
                                        <div class="left-block">
                                            <div class="product-image-container">
                                                <div class="image"> 
                                                    ...
                                                    <a href="" target="_self" title="product">
                                                        <img src="{{asset('public/front/image/catalog/demo/product/index2/270/7.jpg')}}" alt="Mapicola incididuv " class="img-responsive">
                                                    </a>
                                        ...
                                        <div class="left-block">
                                            <div class="product-image-container">
                                                <div class="image"> 
                                                    ...
                                                    <a href="" target="_self" title="product">
                                                        <img src="{{asset('public/front/image/catalog/demo/product/index2/270/8.jpg')}}" alt="Corem ipsum dolor" class="img-responsive">
                                                    </a>
                                        ...
                                        <div class="left-block">
                                            <div class="product-image-container">
                                                <div class="image"> 
                                                    ...
                                                    <a href="" target="_self" title="product">
                                                        <img src="{{asset('public/front/image/catalog/demo/product/index2/270/9.jpg')}}" alt="Benderloin officia" class="img-responsive">
                                                    </a>
                                        ...
                                        <div class="left-block">
                                            <div class="product-image-container">
                                                <div class="image"> 
                                                    ...
                                                    <a href="" target="_self" title="product">
                                                        <img src="{{asset('public/front/image/catalog/demo/product/index2/270/10.jpg')}}" alt="Rumstick shankle" class="img-responsive">
                                                    </a>
                                        ...
                                        <div class="left-block">
                                            <div class="product-image-container">
                                                <div class="image"> 
                                                    ...
                                                    <a href="" target="_self" title="product">
                                                        <img src="{{asset('public/front/image/catalog/demo/product/index2/270/1.jpg')}}" alt="Mapicola incididuv " class="img-responsive">
                                                    </a>
                                        ...
                                        <div class="right-block">
                                            <div class="caption">
                                                ...
                                                <div class="button-group">
                                                    ...
                                                    <a class="btn-button compare" type="button" title="Compare this Product" onclick="compare.add('69');"><i class="fa fa-refresh"></i><span>Compare this Product</span>
                                                    </a>                                                    
                                        ...
                                        <div class="left-block">
                                            <div class="product-image-container">
                                                <div class="image"> 
                                                    ...
                                                    <a href="#" target="_self" title="product">
                                                        <img src="{{asset('public/front/image/catalog/demo/product/index2/270/2.jpg')}}" alt="Corem ipsum dolor" class="img-responsive">
                                                    </a>
                                        ...
                                        <div class="left-block">
                                            <div class="product-image-container">
                                                <div class="image"> 
                                                    ...
                                                    <a href="#" target="_self" title="product">
                                                        <img src="{{asset('public/front/image/catalog/demo/product/index2/270/3.jpg')}}" alt="Benderloin officia" class="img-responsive">
                                                    </a>
                                        ...
                                        <div class="left-block">
                                            <div class="product-image-container">
                                                <div class="image"> 
                                                    ...
                                                    <a href="#" target="_self" title="product">
                                                        <img src="{{asset('public/front/image/catalog/demo/product/index2/270/4.jpg')}}" alt="Ground round enim" class="img-responsive">
                                                    </a>
                                        ...
                                        <div class="left-block">
                                            <div class="product-image-container">
                                                <div class="image"> 
                                                    ...
                                                    <a href="#" target="_self" title="product">
                                                        <img src="{{asset('public/front/image/catalog/demo/product/index2/270/5.jpg')}}" alt="Mapicola incididuv " class="img-responsive">
                                                    </a>
                                        ...
                                        <div class="left-block">
                                            <div class="product-image-container">
                                                <div class="image"> 
                                                    ...
                                                    <a href="#" target="_self" title="product">
                                                        <img src="{{asset('public/front/image/catalog/demo/product/index2/270/6.jpg')}}" alt="Corem ipsum dolor" class="img-responsive">
                                                    </a>
                                        ...
                                        <div class="left-block">
                                            <div class="product-image-container">
                                                <div class="image"> 
                                                    ...
                                                    <a href="#" target="_self" title="product">
                                                        <img src="{{asset('public/front/image/catalog/demo/product/index2/270/7.jpg')}}" alt="Benderloin officia" class="img-responsive">
                                                    </a>
                                        ...
                                        <div class="left-block">
                                            <div class="product-image-container">
                                                <div class="image"> 
                                                    ...
                                                    <a href="#" target="_self" title="product">
                                                        <img src="{{asset('public/front/image/catalog/demo/product/index2/270/8.jpg')}}" alt="Rumstick shankle" class="img-responsive">
                                                    </a>
                                        ...
                                        <div class="left-block">
                                            <div class="product-image-container">
                                                <div class="image"> 
                                                    ...
                                                    <a href="#" target="_self" title="product">
                                                        <img src="{{asset('public/front/image/catalog/demo/product/index2/270/9.jpg')}}" alt="Mapicola incididuv " class="img-responsive">
                                                    </a>
                                        ...
                                        <div class="left-block">
                                            <div class="product-image-container">
                                                <div class="image"> 
                                                    ...
                                                    <a href="#" target="_self" title="product">
                                                        <img src="{{asset('public/front/image/catalog/demo/product/index2/270/10.jpg')}}" alt="Corem ipsum dolor" class="img-responsive">
                                                    </a>
                                        ...
                                        <div class="left-block">
                                            <div class="product-image-container">
                                                <div class="image"> 
                                                    ...
                                                    <a href="#" target="_self" title="product">
                                                        <img src="{{asset('public/front/image/catalog/demo/product/index2/270/1.jpg')}}" alt="Benderloin officia" class="img-responsive">
                                                    </a>
            ...
            <div class="slider-brands clearfix">
                <div class="yt-content-slider contentslider" data-rtl="no" data-loop="yes" data-autoplay="no" data-autoheight="no" data-autowidth="no" data-delay="4" data-speed="0.6" data-margin="0" data-items_column0="7" data-items_column1="6" data-items_column2="3" data-items_column3="2" data-items_column4="1" data-arrows="yes" data-pagination="no" data-lazyload="yes" data-hoverpause="yes">
                    <div class="item">
                     <a href="#"><img src="{{asset('public/front/image/catalog/brands/id4-brand1.jpg')}}" alt="brand"></a>
                     </div>
                     <div class="item">
                     <a href="#"><img src="{{asset('public/front/image/catalog/brands/id4-brand2.jpg')}}" alt="brand"></a>
                     </div>
                     <div class="item">
                     <a href="#"><img src="{{asset('public/front/image/catalog/brands/id4-brand3.jpg')}}" alt="brand"></a>
                     </div>
                     <div class="item">
                     <a href="#"><img src="{{asset('public/front/image/catalog/brands/id4-brand4.jpg')}}" alt="brand"></a>
                     </div>
                     <div class="item">
                     <a href="#"><img src="{{asset('public/front/image/catalog/brands/id4-brand5.jpg')}}" alt="brand"></a>
                     </div>
                     <div class="item">
                     <a href="#"><img src="{{asset('public/front/image/catalog/brands/id4-brand6.jpg')}}" alt="brand"></a>
                     </div>
                     <div class="item">
                     <a href="#"><img src="{{asset('public/front/image/catalog/brands/id4-brand7.jpg')}}" alt="brand"></a>
                     </div>
                     <div class="item">
                     <a href="#"><img src="{{asset('public/front/image/catalog/brands/id4-brand8.jpg')}}" alt="brand"></a>
                     </div>
                     <div class="item">
                     <a href="#"><img src="{{asset('public/front/image/catalog/brands/id4-brand5.jpg')}}" alt="brand"></a>
                     </div>
