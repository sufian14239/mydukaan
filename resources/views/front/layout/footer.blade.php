<footer class="footer-container typefooter-1" style="margin-top: 20px;">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 col-style">
                    <div class="infos-footer">
                        <a href="#"><img src="{{asset('public/front/image/catalog/myDokkan_logo-footer.png')}}" alt="image"></a>
                        <ul class="menu">
                            <li class="adres">Address : MyDokkan, Lahore, Punjab
                                <br>Pakistan</li>
                            <li class="phone">
                                +92 304-1111367 - +92 304-1111367
                            </li>
                            <li class="mail">
                                <a href="mailto:info@mydokkan.com">info@mydokkan.com</a>
                            </li>
                            <li class="time">
                ...
                <div class="col-lg-12 col-xs-12 text-center">
                    <img src="{{ asset('public/front/image/catalog/demo/payment/payment.png') }}" alt="imgpayment">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="footer-bottom ">
        <div class="container">
            <div class="copyright">
                MyDokkan.com © 2020 (A brand of FNStylez SMC Pvt Limited). All Rights Reserved. Developed by <a href="http://www.webeasy.pk/" target="_blank" style="color: #b4b6b9;">WebEasy (pvt) Ltd.
            </div>
        </div>
    </div>
    <!-- /Footer Bottom Container -->
