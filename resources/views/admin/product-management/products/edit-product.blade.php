                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        ...
                                                        {{$product->from}}" name="from" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                                                                        ...
                                                                                        <select  name="color_attribute_values[]" id="color-attribute-values" class="form-control show-tick select2" multiple="multiple">
                                                                                            ...
                                                                                            @if ($values)
                                                                                                @foreach($values as $value)
                                                                                                    ...
                                                                                                    <option value="{{ $value->id }}" selected="selected" style="background:{{ $value->code}};">{{ $value->code}}</option>
                                                                                             @else  
        ...
        <div class="row clearfix" id="variable-product-section">
            ...
            <div class="row" id="size-variation-section">
             <button class="btn btn-success add_field_button" style="margin-bottom: 10px; margin-top:20px;margin-left:10px;">Add More Fields</button>
                ...
                @for( $i=0;$i<$count;$i++)
                                <tr>
             <td><input type="text" name="size[]" value="{{$sizes[$i]}}" class="form-control" placeholder="size"></td>
                  
                                                                       <td>
                      @if($quantity[0]!="")
                    <input value="{{$quantity[$i]}}" type="text" name="quantity[]" class="form-control" placeholder="Quantity">
                                                                        @else
                            ...
                            <div class="col-sm-12">
                                 <div class="form-group"> 
                                    {{-- <div class="form-line"> --}}
                                        ...
                                        <input type="hidden" value="{{$product->category->id}}" id="category">

                                        <input type="hidden" value="{{$product->subcategory->id}}" id="subcategory">
                                        <input type="hidden" value="{{$product->brand->id}}" id="brand">
                                        <select name="subcategory_id"  class="form-control show-tick ms subcategory" required>
                                            @if($subcategories)
                                               ...
                                               @if($product->subcategory->id==$subcat->id)
