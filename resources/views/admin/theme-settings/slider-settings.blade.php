                            ...
                            <form action="{{ route('ds.theme-setting.slider-setting-action') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="color" value="" name="bg_color" class="form-control"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" value="" name="title" class="form-control" placeholder="Slider Title"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="color" value="" name="title_color" class="form-control"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" name="description" class="form-control" placeholder="Slider Description"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <label for="title">Description Color:</label>
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $index }}</td>
                                            <td>
                                                <img class="thumbnail" style="width: 170px;" src="{{ asset('public/slider/').'/'.$slider->image }}" alt="">
                                            </td>
                                            <td>{{ $slider->title }}</td>
